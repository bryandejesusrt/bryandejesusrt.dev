...
export default function Draft() {
  // pagination
  const [currentPage, setCuerrentPage] = useState(1); // for page 1
  ...
  const indexOfFirtBlog = (currentPage - 1) * perPage;
  const indexOfLastBlog = currentPage * perPage;

  //Get current page`s blogs

  const currentBlogs = filteredBlogs.slice(indexOfFirtBlog, indexOfLastBlog);
